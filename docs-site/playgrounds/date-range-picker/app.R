...
ui <- block_page(
  ...
  theme = htmltools::tagList(
    ...
    htmltools::tags$style(htmltools::HTML(
      "
      [data-shinyblocks-root] .showcase-date-range-picker-preview-custom .sb-date-range-picker-trigger,
      [data-shinyblocks-root].showcase-date-range-picker-preview-custom .sb-date-range-picker-trigger {
...
server <- function(input, output, session) {
  output$showcase_date_range_picker_preview_value <- showcase_render_value({
  ...
  outputOptions(output, "showcase_date_range_picker_preview_ui", suspendWhenHidden = FALSE)
  ...
  output$showcase_date_range_picker_preview_code <- showcase_render_code({
    ...
    if (!is.null(start)) args <- c(args, paste0('start = "', start, '"'))
    if (!is.null(end)) args <- c(args, paste0('end = "', end, '"'))
    ...
    if (isTRUE(class_val)) args <- c(args, 'class = "showcase-date-range-picker-preview-custom"')

    paste0("block_date_range_picker(\n  ", paste(args, collapse = ",\n  "), "\n)")
  })
  outputOptions(output, "showcase_date_range_picker_preview_code", suspendWhenHidden = FALSE)
  ...
  observeEvent(input$showcase_date_range_picker_set_q4, {
    update_block_date_range_picker(session, "showcase_date_range_picker_preview", start = "2025-10-01", end = "2025-12-31")
    reactive_code('update_block_date_range_picker(\n  session = session,\n  input_id = "showcase_date_range_picker_preview",\n  start = "2025-10-01",\n  end = "2025-12-31"\n)')
  })
  observeEvent(input$showcase_date_range_picker_clear, {
    update_block_date_range_picker(session, "showcase_date_range_picker_preview", clear = TRUE)
    reactive_code('update_block_date_range_picker(\n  session = session,\n  input_id = "showcase_date_range_picker_preview",\n  clear = TRUE\n)')
  })
  observeEvent(input$showcase_date_range_picker_disable, {
    update_block_date_range_picker(session, "showcase_date_range_picker_preview", disabled = TRUE)
    reactive_code('update_block_date_range_picker(\n  session = session,\n  input_id = "showcase_date_range_picker_preview",\n  disabled = TRUE\n)')
  })
  observeEvent(input$showcase_date_range_picker_enable, {
    update_block_date_range_picker(session, "showcase_date_range_picker_preview", disabled = FALSE)
    reactive_code('update_block_date_range_picker(\n  session = session,\n  input_id = "showcase_date_range_picker_preview",\n  disabled = FALSE\n)')
  })
  observeEvent(input$showcase_date_range_picker_set_bounds, {
    update_block_date_range_picker(
      session,
      "showcase_date_range_picker_preview",
      min = "2025-01-01",

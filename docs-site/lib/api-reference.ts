  ...
  "file-input": [
    {
      ...
      arguments: [
        { argument: "input_id", type: "character", defaultVal: "required", description: "Input identifier returned as input$<id>." },
        { argument: "variant", type: "'button' | 'dropzone'", defaultVal: "'button'", description: "Picker variant: styled button or drag-and-drop surface." },
        ...
        { argument: "dropzone_label", type: "character", defaultVal: "\"Drag files here or click to browse\"", description: "Primary dropzone text (dropzone variant only)." },
        { argument: "dropzone_hint", type: "character", defaultVal: "NULL", description: "Secondary dropzone hint text (dropzone variant only)." },
        { argument: "dropzone_icon", type: "character | tag", defaultVal: "NULL", description: "Icon above the dropzone label: icon name or htmltools tag (dropzone variant only)." },
        { argument: "dropzone_content", type: "tag | tagList", defaultVal: "NULL", description: "Custom dropzone interior; replaces the icon/label/hint stack. Mark the picker trigger with data-dropzone-trigger (dropzone variant only)." },
        { argument: "width", type: "character", defaultVal: "NULL", description: "CSS width applied to the wrapper." },
    ...
    },
    {
      ...
      arguments: [
        ...
        { argument: "variant", type: "'button' | 'dropzone'", defaultVal: "NULL", description: "Switch the picker variant." },
        ...
        { argument: "dropzone_label", type: "character", defaultVal: "NULL", description: "Replace the dropzone primary text." },
        { argument: "dropzone_hint", type: "character", defaultVal: "NULL", description: "Replace the dropzone hint text." },
        { argument: "dropzone_icon", type: "character | tag", defaultVal: "NULL", description: "Replace the dropzone icon (name or tag); NULL clears it." },
        { argument: "dropzone_content", type: "tag | tagList", defaultVal: "NULL", description: "Replace the custom dropzone interior; NULL restores the default stack." },

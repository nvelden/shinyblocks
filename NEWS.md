...
* Added `block_stack()`, `block_cluster()`, and `block_grid()` as package-owned R layout primitives with semantic spacing, alignment, wrapping, and responsive grid composition (issue #72).

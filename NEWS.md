...
* Fixed the responsive `block_sidebar()` drawer so its token-backed surface remains opaque and interactive above the backdrop in narrow app and embedded Shinylive viewports.

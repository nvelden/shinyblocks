htmltools::tagList(
  ...
  htmltools::div(
    ...
    style = "background: var(--sidebar); color: var(--sidebar-foreground); padding: 0.75rem; border-radius: 0.5rem; max-width: 18rem; margin-top: 0.75rem;",
    block_nav(
      ...
      block_nav_group(
        "Admin",
        block_nav_item("Users", icon = "users", value = "users"),
        icon = "folder",
        value = "admin"
      ),

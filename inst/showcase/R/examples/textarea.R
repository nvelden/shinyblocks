    ...
    htmltools::div(
      ...
      htmltools::div(
        ...
        htmltools::div(
          ...
          shiny::verbatimTextOutput("showcase_textarea_preview_value"),
          htmltools::tags$div(
            htmltools::tags$div(
              style = "font-size: 0.75rem; font-weight: 600; color: var(--muted-foreground); margin-bottom: 0.5rem;",
              "UI Definition"
            ),
            shiny::verbatimTextOutput("showcase_textarea_preview_code")
          ),
          htmltools::tags$div(
            htmltools::tags$div(
              style = "font-size: 0.75rem; font-weight: 600; color: var(--muted-foreground); margin-bottom: 0.5rem;",
            ...
            shiny::verbatimTextOutput("showcase_textarea_reactive_code")
          )
        ),
        htmltools::div(

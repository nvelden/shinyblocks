...
The maintainer-local `components.json` records the upstream variant.
When that file is not present in a public checkout, this section is the
source of truth:
...
<!-- Add new entries at the top. Format below. -->

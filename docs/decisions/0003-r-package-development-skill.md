...
`shinyshadcn` is an R package. Agent work should follow R package conventions for exported APIs, tests, documentation, and checks. The Posit `r-package-development` skill provides focused guidance for `devtools`, `testthat`, `roxygen2`, formatting, `NEWS.md`, and package infrastructure.
